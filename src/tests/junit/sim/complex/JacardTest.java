...
public class JacardTest {
	 ...
	 * ***/
	@Test
	public void TestJacard(){
		
		ComplexSimilarityMetricStrategy simMetric1 = new Jacard();
		...
		assertEquals(flags.similarity(flags1),0.375,0.001);
